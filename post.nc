...
G1 X4.5000 (linear move in X)
G1 Z-0.2000 (move to next cutting depth)
G1 Y0.0000 (linear move in Y)
G1 X4.5000 (linear move in X)
G3 X4.5000 Y0.2500 I0 J0.125 (CW move)
G1 Y0.2500 (linear move in Y)
...
G1 Y2.0000 (linear move in Y)
G1 X4.5000 (linear move in X)
G1 Z-0.3000 (move to next cutting depth)
G1 Y0.0000 (linear move in Y)
G1 X4.5000 (linear move in X)
G3 X4.5000 Y0.2500 I0 J0.125 (CW move)
G1 Y0.2500 (linear move in Y)
...
G1 Y2.0000 (linear move in Y)
G1 X4.5000 (linear move in X)
G1 Z-0.4000 (move to next cutting depth)
G1 Y0.0000 (linear move in Y)
G1 X4.5000 (linear move in X)
G3 X4.5000 Y0.2500 I0 J0.125 (CW move)
G1 Y0.2500 (linear move in Y)
...
G1 Y2.0000 (linear move in Y)
G1 X4.5000 (linear move in X)
G1 Z-0.5000 (move to next cutting depth)
G1 Y0.0000 (linear move in Y)
G1 X4.5000 (linear move in X)
G3 X4.5000 Y0.2500 I0 J0.125 (CW move)
G1 Y0.2500 (linear move in Y)
